...
<x-filament-widgets::widget class="summit-dashboard">
    <div class="summit-dashboard-shell">
        <div class="summit-dashboard-header">
            <div>
                <p class="summit-dashboard-eyebrow">Owner dashboard</p>
                <h2 class="summit-dashboard-title">Financial overview</h2>
                <p class="summit-dashboard-copy">
                    Cash collection, bank balance, profit, dues, staff commission, and liabilities in one place.
                </p>
            </div>
        ...
        <div class="summit-dashboard-section-grid">
            @foreach ($sections as $section)
                <section class="summit-dashboard-section summit-dashboard-section-{{ $section['accent'] }}">
                    <div class="summit-dashboard-section-header">
                        <span class="summit-dashboard-section-icon">

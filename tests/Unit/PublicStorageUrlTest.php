...
class PublicStorageUrlTest extends TestCase
{
    ...
    {
        $this->assertSame('http://localhost/storage/cms/team/member.jpg', PublicStorageUrl::make('cms/team/member.jpg'));
        $this->assertSame('http://localhost/storage/cms/team/member.jpg', PublicStorageUrl::make('public/cms/team/member.jpg'));
        $this->assertSame('http://localhost/storage/cms/team/member.jpg', PublicStorageUrl::make('storage/cms/team/member.jpg'));
        $this->assertSame('http://localhost/storage/cms/team/member.jpg', PublicStorageUrl::make('/cms/team/member.jpg'));
